 ...
 * CONSTRAINT parent_fk FOREIGN KEY (`parent_id`) REFERENCES `list`(`list_id`) ON UPDATE CASCADE ON DELETE CASCADE, 
 * CONSTRAINT child_fk FOREIGN KEY (`child_id`) REFERENCES `list`(`list_id`) ON UPDATE CASCADE ON DELETE CASCADE);",
 ...
 * "CREATE TABLE `note_relationship` ( 
 * `list_id` INT UNSIGNED NOT NULL, 
 * `note_id` INT UNSIGNED NOT NULL, 
 * CONSTRAINT list_fk FOREIGN KEY (`list_id`) REFERENCES `list`(`list_id`) ON UPDATE CASCADE ON DELETE CASCADE, CONSTRAINT note_fk FOREIGN KEY (`note_id`) REFERENCES `note`(`note_id`) ON UPDATE CASCADE ON DELETE CASCADE);",
 * 
  "INSERT INTO 
 * `list`(`list_name`) VALUES ('Note-A-List');"
 * ];
